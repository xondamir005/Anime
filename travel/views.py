...
from .models import Places, PlaceDetail, Gallarey, ContactUs, Rate, LogoutModel
import requests
    ...
    def post(self, request, *args, **kwargs):
        if request.method == "POST":
            ...
            if form.is_valid():
                ...
                token = '6415110536:AAGxLWfVG68fTMmh6U2xXujCT3devFaADss'
                ...
                requests.get(url + str(6083674999) + '&text=' + text)
                form.save()
                return redirect('/')
        else:
            form = OrderPlaceForm()
